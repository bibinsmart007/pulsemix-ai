...
# Replace all <style> blocks (across multiple) with just one
pattern = r'<style>[\s\S]*?</style>'
html = re.sub(pattern, '', html)

# Insert the single majestic one right before </head>
